...
export enum ErrorCodes {
  ...
  "notFound" = "No data was found on the server by the given parameters.",
  "unknown" = "Some other problem occured.",
  "fourOFour" = "Nothing to see here. Probably, a fancy 404 screen will replace this text.",
}
